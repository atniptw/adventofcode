...
const testPath = path.join(__dirname, '..', 'test', year);
const solutionFile = path.join(srcPath, `day-${dayPadded}.ts`);
const testFile = path.join(testPath, `day-${dayPadded}.spec.ts`);
const inputFile = path.join(srcPath, 'inputs', `day-${dayPadded}.txt`);
